    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(editable=False, choices=[
                 ('NW', 'New'), ('US', 'Used'), ('DS', 'Disabled')], verbose_name='status', max_length=2, default='NW')),
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, null=True,
                                                 blank=True, related_name='created_tickets_ticketcode', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, null=True,
                                                  blank=True, related_name='modification_tickets_ticketcode', to=settings.AUTH_USER_MODEL)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, null=True,
                                                 blank=True, related_name='created_tickets_ticketpack', to=settings.AUTH_USER_MODEL)),
                ('event', models.ForeignKey(related_name='ticket_packs', to='events.Event')),
                ('modified_by', models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, null=True,
                                                  blank=True, related_name='modification_tickets_ticketpack', to=settings.AUTH_USER_MODEL)),
            ],
            options={
            },
            bases=(models.Model,),
